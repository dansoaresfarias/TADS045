...
-- Porjeto de banco de dados para o ensino da disciplina de Banco de Dados: DDL e DML.
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `PousadaDorama` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ;
USE `PousadaDorama` ;

-- -----------------------------------------------------
-- Table `PousadaDorama`.`Funcionario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`Funcionario` (
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`Endereco`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`Endereco` (
  ...
  CONSTRAINT `fk_Endereco_Fucnionario`
    ...
    REFERENCES `PousadaDorama`.`Funcionario` (`CPF`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`Telefone`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`Telefone` (
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`Dependente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`Dependente` (
  `CPF` VARCHAR(14) NOT NULL,
  `nome` VARCHAR(60) NOT NULL,
  `dataNasc` DATE NOT NULL,
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`OcorrenciaInterna`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`OcorrenciaInterna` (
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`RegistroPonto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`RegistroPonto` (
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`Ferias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`Ferias` (
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`Departamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`Departamento` (
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`Cargo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`Cargo` (
  `CBO` INT NOT NULL,
  `nome` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`Trabalhar`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`Trabalhar` (
  `Funcionario_CPF` VARCHAR(14) NOT NULL,
  ...
  CONSTRAINT `fk_Funcionario_has_Departamento_Departamento1`
    ...
    REFERENCES `PousadaDorama`.`Departamento` (`idDepartamento`)
    ON DELETE RESTRICT
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Trabalhar_Cargo1`
    FOREIGN KEY (`Cargo_CBO`)
    REFERENCES `PousadaDorama`.`Cargo` (`CBO`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`Hospede`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`Hospede` (
  ...
  CONSTRAINT `fk_Hospede_Hospede1`
    ...
    REFERENCES `PousadaDorama`.`Hospede` (`docIdentificacao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`Reserva`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`Reserva` (
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`TipoUH`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`TipoUH` (
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`UH`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`UH` (
  ...
  CONSTRAINT `fk_UH_TipoUH1`
    ...
    REFERENCES `PousadaDorama`.`TipoUH` (`idTipoUH`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`UH_Reserva`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`UH_Reserva` (
  ...
  CONSTRAINT `fk_UH_has_Reserva_UH1`
    FOREIGN KEY (`UH_idUH`)
    REFERENCES `PousadaDorama`.`UH` (`idUH`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_UH_has_Reserva_Reserva1`
    FOREIGN KEY (`Reserva_idReserva`)
    REFERENCES `PousadaDorama`.`Reserva` (`idReserva`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`Hospedagem`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`Hospedagem` (
  `Reserva_idReserva` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`Hospedar`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`Hospedar` (
  ...
  CONSTRAINT `fk_Hospedagem_has_Hospede_Hospedagem1`
    ...
    REFERENCES `PousadaDorama`.`Hospedagem` (`Reserva_idReserva`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`Produto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`Produto` (
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`ItensHospedagem`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`ItensHospedagem` (
  `Hospedagem_Reserva_idReserva` INT NOT NULL,
  ...
  CONSTRAINT `fk_Hospedagem_has_Produto_Produto1`
    ...
    REFERENCES `PousadaDorama`.`Produto` (`idProduto`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`Ocorrencia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`Ocorrencia` (
...
-- -----------------------------------------------------
-- Table `PousadaDorama`.`FormaPag`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PousadaDorama`.`FormaPag` (
...
-- -----------------------------------------------------
DROP PROCEDURE IF EXISTS `PousadaDorama`.`sp_gerar_hospedagem_completa`;
...
-- -----------------------------------------------------
CREATE PROCEDURE `PousadaDorama`.`sp_gerar_hospedagem_completa`(IN total_registros INT)
BEGIN
	-- -----------------------------------------------------
